...
const Comments = () => {
  ...
  return (
    <div className="lg:w-[850px] mx-auto p-4 mb-6 text-center lg:mb-12 leading-snug space-y-2"  data-aos="fade-up">
      ...
      <p className="Playfair text-2xl space-y-1">
        They are doing amazing job with hundred percent <br /> customer satisfaction,
        Love their work and would <br /> like to work with them again
      </p>
      ...
      {profiles.map((profile, index) => (
        ...
        >
          ...
          />
          <div>
            <h3 className="text-sm font-semibold text-gray-800 leading-5">{profile.name}</h3>
